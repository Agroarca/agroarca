...
<div class="card card-default collapsed-card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.produtos.produtos.icms.atualizar', $produto->id) }}" method="POST">
            @csrf
                    ...
                    <tbody>
                        @foreach ($produto->icmsEstado as $icms)
                            <tr>
                                ...
                                <td>{{ $icms->icms }}</td>
                                <td>
                                    <a href="{{ route('admin.produtos.produtos.icms.excluir', [$produto->id, $icms->id]) }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Excluir">
        ...
        <form action="{{ route('admin.produtos.produtos.icms.adicionar', $produto->id) }}" method="POST">
            @csrf
            <div class="card card-secondary">
                <div class="card-header">

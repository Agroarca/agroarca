...
<x-admin>
    ...
    <form action="{{ route('admin.produtos.produtos.atualizar', $produto->id) }}" method="POST">
    ...
    @include('admin.produtos.produtos.icms', ['produto' => $produto])
    @include('admin.produtos.produtos.imagens', ['produto' => $produto])
</x-admin>

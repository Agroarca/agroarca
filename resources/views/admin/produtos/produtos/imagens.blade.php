<form action="{{ route('admin.produtos.produtos.imagens.upload', $produto->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            @forelse ($produto->imagens as $imagem)
                <div class="col-md-12 col-lg-6 col-xl-4 mb-3">
                    ...
                    <a href="{{ route('admin.produtos.produtos.imagens.delete', [$produto->id, $imagem->id]) }}" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Excluir">

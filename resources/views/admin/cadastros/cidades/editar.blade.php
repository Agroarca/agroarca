        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <x-admin.select name='estado_id' :values="Estado::selectTodos()" :selected="$cidade->estado_id" placeholder="Selecione um Estado" :class="['form-control', 'is-invalid' => $errors->has('estado_id')]"> </x-admin.select>

...
<x-admin>
    ...
    <form action="{{ route('admin.cadastros.usuarios.enderecos.salvar', $userId) }}" method="POST">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nome" value="{{ old('nome') }}" placeholder="Ex.: Casa, Trabalho..."
                ...
                <div class="form-group">
                    ...
                    <x-admin.select name='cidade_id' :values="Cidade::selectTodos()" :selected="old('cidade_id')" placeholder="Selecione uma Cidade"
                        :class="['form-control', 'is-invalid' => $errors->has('cidade_id')]"></x-admin.select>
                    <x-admin.form-error property='cidade_id'></x-admin.form-error>
                </div>

                <div class="form-group">
                    <label for="endereco">Endereço:</label>
                    <input type="text" name="endereco" value="{{ old('endereco') }}" placeholder="Ex.: Avenida Paulista, Rua Madalena..."
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="complemento" value="{{ old('complemento') }}" placeholder="Ex.: AP 126"

        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <x-admin.select name='cidade_id' :values="Cidade::selectTodos()" :selected="$centroDistribuicao->cidade_id" placeholder="lecione uma Cidade" :class="['form-control', 'is-invalid' => $errors->has('cidade_id')]"></x-admin.select>

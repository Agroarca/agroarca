...
<x-admin>
    ...
    <form action="{{ route('admin.pedidos.formas_pagamento.salvar') }}" method="POST">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <x-admin.select name='tipo' :values="TipoFormaPagamento::$customNames" :selected="old('tipo')" placeholder="Selecione um Tipo" :class="['form-control', 'is-invalid' => $errors->has('tipo')]"></x-admin.select>
                ...
                <div class="form-group">
                    ...
                    <x-admin.select name='modalidade' :values="ModalidadeFormaPagamento::$customNames" :selected="old('modalidade')" placeholder="Selecione uma Modalidade" :class="['form-control', 'is-invalid' => $errors->has('modalidade')]"></x-admin.select>

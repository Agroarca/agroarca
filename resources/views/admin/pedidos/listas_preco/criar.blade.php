...
<x-admin>
    ...
    <form action="{{ route('admin.pedidos.listas_preco.salvar') }}" method="POST">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="data" value="{{ old('data') }}" @class(['form-control', 'is-invalid' => $errors->has('data')]) />
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="data_inicio" step="1" value="{{ old('data_inicio') }}" @class(['form-control', 'is-invalid' => $errors->has('data_inicio')]) />
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="data_fim" step="1" value="{{ old('data_fim') }}" @class(['form-control', 'is-invalid' => $errors->has('data_fim')]) />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="ajuste_mensal" value="{{ old('ajuste_mensal') }}" @class(['form-control mask-percentual', 'is-invalid' => $errors->has('ajuste_mensal')]) />

        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="data_inicial_entrega" value="{{ $itemListaPreco->data_inicial_entrega }}" @class(['form-control', 'is-invalid' => $errors->has('data_inicial_entrega')]) />
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="data_final_entrega" value="{{ $itemListaPreco->data_final_entrega }}" @class(['form-control', 'is-invalid' => $errors->has('data_final_entrega')]) />
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="minimo_dias_entrega" value="{{ $itemListaPreco->minimo_dias_entrega }}" @class(['form-control mask-integer', 'is-invalid' => $errors->has('minimo_dias_entrega')]) />

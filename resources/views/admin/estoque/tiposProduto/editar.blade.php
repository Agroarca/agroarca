...
<x-admin>
    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            <form action="{{ route('admin.estoque.tiposProduto.adicional', $tipoProduto->id) }}" method="POST" class="form-inline">
                @csrf
                <div class="form-group">
                    ...
                    <tbody>
                        @foreach ($tipoProduto->tiposProdutosAdicionais as $tipoProdutoAdicional)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.estoque.tiposProduto.excluirAdicional', [$tipoProduto->id, $tipoProdutoAdicional->id]) }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Excluir">

...
var Cropper = __webpack_require__(/*! cropperjs */ "./node_modules/cropperjs/dist/cropper.js");

var CropperUtils = /*#__PURE__*/function () {
  function CropperUtils() {
    _classCallCheck(this, CropperUtils);
  ...
  _createClass(CropperUtils, [{
    ...
    key: "readImage",
    value: function readImage(event) {
    ...
    key: "setupCropper",
    value: function setupCropper(file) {
    ...
    value: function saveCrop() {
      ...
      canvas.toBlob(function (blob) {
        var file = new File([blob], "imagem.png", {
          type: "image/png",
          lastModified: new Date().getTime()
        });
        var container = new DataTransfer();
        container.items.add(file);
        document.querySelector(".crop-image-upload").files = container.files;
      }, "image/png", 1);
